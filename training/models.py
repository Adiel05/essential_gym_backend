...
class Exercise(models.Model):
    ...
    machine_required = models.CharField(max_length=100, blank=True, null=True)  # máquina o "peso libre"
...
class Routine(models.Model):
    ...
    created_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='created_routines')
    is_template = models.BooleanField(default=False, help_text="Si es plantilla para usar con múltiples usuarios")
...
class WorkoutLog(models.Model):
    ...
    actual_weights = models.JSONField(default=dict, blank=True)  # ej: {exercise_id: weight}
